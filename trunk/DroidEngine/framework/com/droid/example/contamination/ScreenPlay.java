...
public class ScreenPlay extends GameObject {
	...
	public void render(GameGraphics g) {
		...
		this.fontManager.getFont("FPS Font")
				.drawString(
						g,
						"SCORE:" + score + "/" + SCORE_WIN + " TIME:"
								+ this.remainTime, GameFont.CENTER, 14, 10,
						this.getWidth());
	}
	...
	public void update(long elapsedTime) {
		...
		if (this.score <= 0 || this.score >= SCORE_WIN || this.remainTime <= 0) {
