 ...
 * {@link com.droid.gamedev.object.sprite.AdvanceSprite}.
 * 
 * @see com.droid.gamedev.object.sprite.AdvanceSprite
 */
public class AnimatedSprite extends Sprite {
	...
	public AnimatedSprite(GameImage[] image, double x, double y, int animationSpeed) {
		super(x, y);
		...
		this.animationTimer = new Timer(animationSpeed);
	}
	 ...
	 */
	public AnimatedSprite(GameImage[] images, double x, double y) {
		this(images, x, y, DEFAULT_ANIMATION_SPEED);
	}
	 ...
	 */
	public AnimatedSprite(GameImage[] image) {
		this(image, 0, 0);
	}
	...
	public void render(GameGraphics g, int xs, int ys) {
		g.drawImage(this.image[this.frame], xs, ys);
	}
