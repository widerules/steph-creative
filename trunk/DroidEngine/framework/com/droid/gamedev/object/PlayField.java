 ...
 * @see com.droid.gamedev.object.CollisionManager
 */
public class PlayField {
	 ...
	 * {@link com.droid.gamedev.object.SpriteGroup#clear()}
	 */
	 ...
	 */
	protected void renderBackground(GameGraphics g) {
	 ...
	 */
	protected void renderSpriteGroups(GameGraphics g) {
		for (int i = 0; i < this.groups.length; i++) {
			if (this.groups[i].isActive()) {
	 ...
	 * disposed.
	 */
	protected void renderSpriteGroups(GameGraphics g, Comparator<Sprite> c) {
